...
#
#   
#    Further, we strongly encourage you to obtain the latest version of RM
...
ifeq ($(USEICC),1)
CC       = mpiicc
CCFLAGS2  = -O2 -xhost -restrict -ipo #-xSSE4.2 #-no-prec-div #-axCORE-AVX2 #-O2 #-xAVX 
#CCFLAGS2  = -O2 -axAVX,CORE-AVX2 #-xhost -restrict #-ipo #-no-prec-div #-axCORE-AVX2 -xSSE4.2 #-O2 #-xAVX 
#CCFLAGS  = -O2
ifeq ($(USEOMP),1)
CCFLAGS = $(CCFLAGS2) -qopenmp
else
CCFLAGS = $(CCFLAGS2)
endif
