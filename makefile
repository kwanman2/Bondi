...
#BIN2TXTLIBS=-lmfhdf -ldf -ljpeg -lz -lv5d
BIN2TXTLIBS1=$(BIN2TXTLIBS)
BIN2TXTLIBS2=$(BIN2TXTLIBS)
...
###########################################
# BEGIN for hku-hpc
hdfdir=/home/kwanman2/hdf4
v5ddir=/home/kwanman2/Vis5dPlus
BIN2TXTLIBS=-I$(hdfdir)/include/ -L$(hdfdir)/lib/ -lmfhdf -ldf -I$(v5ddir)/include/ -L$(v5ddir)/lib/ -ljpeg -lz -lv5d -ltcl8.5 -lGLU -lGL -lSM -luuid -lICE -lXext -lX11 -lxcb -lXau -ldl -lpng12 -lm -lpthread #-lxcb-xlib
BIN2TXTLIBS1=$(BIN2TXTLIBS)
BIN2TXTLIBS2=$(BIN2TXTLIBS)
#END for hku-hpc
###########################################
